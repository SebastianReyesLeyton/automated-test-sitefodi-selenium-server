...
const ShowUserContentComponent = ({ infoContent }) => {
        ...
        <div className="show-user-container">
            ...
            <section className="show-user-content">
                <section className="general-info">
                    <img alt="" src={Avatars[Math.floor(Math.random() * Avatars.length)]} className="avatar" />
                    <h1>{userData.name}</h1>
...
export default ShowUserContentComponent;